...
def generate(name,category,save):
	...
	eg. python domain-gistry.py generate yourdomain --category common --save yes

	eg. python domain-gistry.py generate yourdomain -c common 
	
	eg. python domain-gistry.py generate "your domain"
...
def get_common(name):
	...
	eg. python domain-gistry.py get-common example

	eg. domain-gistry.py get-common example
...
def get_extra(name):
	...
	eg. python domain-gistry.py get-extra example

	eg. domain-gistry.py get-extra example
...
def get_new(name):
	...
	eg. python domain-gistry.py get-new example

	eg. domain-gistry.py get-new example
...
def get_prefix(name):
	...
	eg. python domain-gistry.py get-prefix example

	eg. domain-gistry.py get-prefix example
...
def get_suffix(name):
	...
	eg. python domain-gistry.py get-suffix example

	eg. domain-gistry.py get-suffix example
...
def get_all(name,save):
	...
	eg. python domain-gistry.py get-all example

	eg. domain-gistry.py get-all example
...
def info():
	...
	eg. python domain-gistry.py info

	eg domain-gistry.py info
